...
window.addEventListener("focus", () => setCursorVisibility(true));
...
document
  .querySelectorAll("a, button, .filter-btn, .project-card")
  .forEach((el) => {
      ...
      if (show) {
        ...
        setTimeout(() => {
          card.style.transition =
            "opacity .4s ease, transform .4s ease, border-color .3s, box-shadow .3s";
...
console.log(
  "%c⚡ KRISH JAISWAL PORTFOLIO",
  "color:#c8ff00;font-family:monospace;font-size:18px;font-weight:bold;",
);
console.log(
  "%cDesigned & Built by Krish Jaiswal",
  "color:#ff2d6f;font-family:monospace;font-size:12px;",
);
console.log(
  "%c🎨 Graphic Designer · CS(AI) Student · Lucknow",
